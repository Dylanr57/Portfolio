            ...
            <section className = "row">
                <div className = "col-md-12">
                    <article className = "block">
                        ...
                        <p>My name is Dylan Reeves and I am a junior full stack web developer. I completed the Full Stack Web Development Boot Camp at UCLA, where I learned a host of programming languages and skills, including HTML, CSS, and JavaScript as well as how to create and manage databases using MySQL and MongoDB. During the program I worked with my fellow teammates to create a range of different web applications, including a Google Map based job search site, as well as a movie recommendation site. I am currently working on personal projects to help further sharpen my skills as well as learn new ones.</p>
